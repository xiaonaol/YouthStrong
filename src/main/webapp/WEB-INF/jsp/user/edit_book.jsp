								...
								<form class="form-horizontal" role="form">
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<input type="text" id="b_name" name="b_name" value="${book.b_name }" placeholder="请填写物资名称" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 捐赠人 </label>
										<div class="col-sm-9">
											<input type="text" id="b_author" name="b_author" value="${book.b_author }" placeholder="请填写捐赠人" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 捐赠日期 </label>
										<div class="col-sm-9">
