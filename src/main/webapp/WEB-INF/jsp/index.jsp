	...
	<body class="no-skin">
		<div id="navbar" class="navbar navbar-default ace-save-state">
			<div class="navbar-container ace-save-state" id="navbar-container">
				<div class="navbar-header pull-left">
					<a href="${pageContext.request.contextPath}/user/main" class="navbar-brand" target="right">
			...
			<div id="sidebar" class="sidebar responsive ace-save-state">
				<ul class="nav nav-list">
					<li class="nav-top-li active" id="side1">
						<a href="${pageContext.request.contextPath}/user/main" target="right" onclick="profile()">
					...
					<li class="nav-top-li" id="side2">
						<a href="#" class="dropdown-toggle" target="right" onclick="user_profile()">
					...
					<li class="nav-top-li" id="side3">
						<a href="#" class="dropdown-toggle" target="right" onclick="book_donation()">
							<i class="menu-icon fa fa-book"></i>
							<span class="menu-text">图书捐赠</span>
						</a>
						<b class="arrow"></b>
					</li>
		...
		<script type="text/javascript">
			$(function() {
				...
				$(".iframe-box").attr("src", "${pageContext.request.contextPath}/user/main");
			});
			...
			function user_profile() {
				...
				$(".iframe-box").attr("src", "${pageContext.request.contextPath}/user/user_profile");
			}
			
			function book_donation() {
				$("#sidebar ul li").removeAttr('class');
				$('#side3').attr('class','nav-top-li active');
				$(".iframe-box").attr("src", "${pageContext.request.contextPath}/user/book_donation");
			}
			
			function donation_history() {
				$("#sidebar ul li").removeAttr('class');
				$('#side4').attr('class','nav-top-li active');
				$(".iframe-box").attr("src", "${pageContext.request.contextPath}/user/donation_history");
			}
			...
			function check_0() {
				...
				$(".iframe-box").attr("src", "${pageContext.request.contextPath}/user/toBookCheck_0");
			}
			...
			function check_1() {
				...
				$(".iframe-box").attr("src", "${pageContext.request.contextPath}/user/toBookCheck_1");
			}
			...
			function check_2() {
				...
				$(".iframe-box").attr("src", "${pageContext.request.contextPath}/user/toBookCheck_2");
			}
